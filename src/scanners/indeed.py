"""Indeed job scanner via python-jobspy."""
...
class IndeedScanner(BaseScanner):
    ...
    async def scan(self) -> list[Job]:
        ...
        log.info("indeed_scan_complete", total_jobs=len(all_jobs))
        return all_jobs
    ...
    def _dataframe_to_jobs(self, df) -> list[Job]:
        ...
        for _, row in df.iterrows():
            try:
                ...
                log.debug("indeed_parse_row_error", error=str(e))
        return jobs
