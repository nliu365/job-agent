"""LinkedIn job scanner via python-jobspy."""
...
class LinkedInScanner(BaseScanner):
    ...
    async def scan(self) -> list[Job]:
        ...
        log.info("linkedin_scan_complete", total_jobs=len(all_jobs))
        return all_jobs
    ...
    def _dataframe_to_jobs(self, df) -> list[Job]:
        ...
        for _, row in df.iterrows():
            try:
                ...
                log.debug("linkedin_parse_row_error", error=str(e))
        return jobs
